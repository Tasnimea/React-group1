...
<div className='row justify-content-between m-2'>
    ...
    style={{backgroundColor:"rgb(230, 230, 230)"}}>
        ...
        <div className='py-2'  style={{color:"gray"}}>رائع</div>
    ...
    style={{backgroundColor:"rgb(230, 230, 230)"}}>
        ...
        <div className='py-2' style={{color:"gray"}}>المطعم جدا لذيذ</div>
    ...
    style={{backgroundColor:"rgb(230, 230, 230)"}}>
        ...
        <div className='py-2' style={{color:"gray"}}>نصيحة ماحدش يطلب منه انا كان بقالى كتير ماكلتش منه بس بجد اسوء اكلفى التاريخ و غالى على الفاضى و الاكل نفسه معمول وحش ورقة اللحمة سيئة للغاية الرقاق مالوش علاقة بطعم الرقاق اصلاً و غالى جداً على قطعة صغيرة فعلاً فشلة 👎🏻👎🏻</div>
    </div>
